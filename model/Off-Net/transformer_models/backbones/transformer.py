...
def main():
    ...
    # Create a sample input tensor of shape (1, 3, 360, 640)
    input_tensor = torch.randn(1, 3, 360, 640)

    # Forward pass through the model
    output = model(input_tensor, input_tensor)  # 输入相同张量作为x和y

    # Print the output
    print("Output shape:", [o.shape for o in output])  # 输出每个阶段的张量形状
