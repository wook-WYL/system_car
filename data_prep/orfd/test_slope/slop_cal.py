...
if __name__ == "__main__":
    ...
    parser.add_argument("--slope_threshold", type=float, default=15, help="Slope threshold in degrees for traversability cost")
    ...
    for seq_name in seq_dict.keys():
        ...
        for i, str_frame in enumerate(tqdm(seq_dict[seq_name], desc=description)):
            ...
            np.save(os.path.join(save_root, "slope_array" ,str_frame + ".npy"), coordinates_and_slope)
